...
async def init_db():
    async with aiosqlite.connect(DB_NAME) as db:
        ...
        defaults = {
            ...
            "welcome_text": "Welcome to Our Bot!\n\nExplore features, view demos, check subscriptions, or manage your account using the buttons below.",
            "plans_text": "Choose Your Membership Plan\n\nSelect any plan below to get an instant UPI QR payment card:",
        ...
        try:
            ...
            try:
                await manager.bot.send_message(
                    chat_id=admin_id,
                    text=f"{caption}\n\n(Screenshot could not be loaded directly)",
                    parse_mode="HTML",
                    reply_markup=builder.as_markup(),
                )
            except Exception:
